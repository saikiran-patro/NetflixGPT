...
const MovieCard = ({movies}) => {
  ...
  return (
   ...
   <div className="relative">
     <button onClick={scrollLeft} id="scrollLeft" className="px-4 py-2 bg-transparent text-4xl absolute top-[35%] text-white z-12">
     <MdKeyboardArrowLeft />
      </button>
    ...
    <button onClick={scrollRight} id="scrollRight" className="px-4 py-2 bg-transparent text-4xl text-white absolute right-0  top-[35%] z-12">
